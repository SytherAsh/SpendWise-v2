...
- **Required Tests:** Manual QA checklist (Espresso deferred per `docs/testing.md`); a
...
- **Grounded in:** `docs/user_flows.md` Onboarding step 2; `docs/testing.md` "Android UI (Espresso) — Deferred".
...
- **Grounded in:** `docs/user_flows.md` Onboarding step 3; `docs/decisions.md` ADR-005; `docs/security.md` Consent at Onboarding.
...
- **Estimated Complexity:** Medium
- **Depends on:** E9-S1-T2
- **Grounded in:** `docs/user_flows.md` Onboarding steps 4-5 + "SMS Permission Denied" edge case.
...
- **Estimated Complexity:** Medium
- **Depends on:** E9-S1-T3
- **Grounded in:** `docs/user_flows.md` Onboarding steps 6-7; `docs/api.md` `/users/me/bank-statement`.
...
- **Grounded in:** `docs/user_flows.md` Onboarding steps 8-10; `docs/architecture.md` First-Launch SMS Inbox Backfill.
...
- **Grounded in:** `docs/user_flows.md` "Reviewing Transactions" flow.
...
- **Grounded in:** `docs/user_flows.md` "Exporting a Report"; `docs/security.md` Privacy Policy requirement.
